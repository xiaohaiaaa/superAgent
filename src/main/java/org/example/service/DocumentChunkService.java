...
public class DocumentChunkService {
    ...
    /**
     * 使用 Spring AI TokenTextSplitter 进行文档分片
     * 基于token数量进行智能分片，保持语义完整性
     *
     * @param content 文档内容
     * @param filePath 文件路径（用于日志）
     * @return 文档分片列表
    ...
    public List<DocumentChunk> chunkDocumentV2(String content, String filePath) {
        ...
        try {
            ...
            TokenTextSplitter splitter = new TokenTextSplitter(
                chunkConfig.getMaxSize(),      // chunkSize
                chunkConfig.getOverlap(),      // overlap
                5,                             // minChunkSizeToEmbed
                10000,                         // maxChunkSizeToEmbed
                true                           // keepSeparator
            );
